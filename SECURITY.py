...
def selectAVATAR(avt=0):
	...
	avatarChoosen = avt
	i=1
	for avtr in (avtb1,avtb2,avtb3,avtb4):
		if i==avt:
			avtr['state'] = 'disabled'
...
if __name__ == '__main__':
	...
	welcLbl = Label(root1, text='Hi Welcome to \nPersonal Assistant \n ALEX', font=('Arial Bold', 15), fg='#303E54', bg=background)
	...
	usernameLbl = Label(root4, text="Gopi Chand", font=('Arial Bold',15), bg=background, fg='#85AD4F')
